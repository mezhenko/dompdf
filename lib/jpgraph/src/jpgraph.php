...
class Graph {
    ...
    public $titlebkg_scolor1='black',$titlebkg_scolor2='red';
    ...
    public $iImgTrans=false,
           ...
           $iImgTransFillColor='#ff0000',$iImgTransHighQ=false,
    ...
    function Stroke($aStrokeFileName='') {
        ...
        if( !$_csim ) {
            ...
            // streamed back
            imagesavealpha($this->img->img,true);
            ...
            if( ($i % $this->label_step)==0 ) {
                ...
                if( $this->scale->type == "x" ) {
                    ...
                    if( $this->labelPos == SIDE_DOWN ) {
                        ...
                        $this->img->StrokeText($tpos,$aPos+ $tick_label_margin,$label,
                        ...
                        $this->img->StrokeText($tpos,$aPos- $tick_label_margin -1,$label,
                        $this->label_angle,$this->label_para_align);
                    }
                }
                else {
                    ...
                    if( $this->labelPos == SIDE_LEFT ) { // To the left of y-axis
                        ...
                        $this->img->StrokeText($aPos- $tick_label_margin,$tpos,$label,$this->label_angle,$this->label_para_align);
                    }
